  ...
  return (
    <section
      ...
      className="w-full  min-h-screen 
       justify-center flex xl:flex-row flex-col gap-10 max-container "
    >
      <div
      ...
      >
        ...
        <div
          className="flex mt-20 justify-start items-start flex-wrap
          w-full gap-16"
        >
          {statistics.map((stat) => (
            <div key={stat.label}>
      ...
      <div
        className="relative flex flex-col flex-1 justify-center items-center 
        ...
        <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6">
          {shoes.map((shoe) => (
            <div key={shoe}>
              <ShoeCard
                imgUrl={shoe}
                changeBigShoeImage={(clickedShoe) => {
                  setBigShoeImg(clickedShoe);
                }}
